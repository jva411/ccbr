...
public class IsBuilder {
    ...
    public static boolean compareTo(ItemStack IS1, ItemStack is2){
        ItemStack IS2 = is2.clone();
        IS2.setAmount(IS1.getAmount());
        return IS2.equals(IS1);
    }
    ...
    public IsBuilder remEnchantment(Enchantment ench){
