...
public class ItemAPI {
    ...
    public ItemStack newItem(int id, int data, int amount){
        return new ItemStack(id, amount, (short)0, (byte)data);
    }
    public ItemStack newItem(int id, int data){
        return newItem(id, data, 1);
    }
    public ItemStack newItem(int id){
        return newItem(id, 0, 1);
    }
    ...
    public ItemStack addLore(ItemStack is, int line, String lr){
        ism = is.getItemMeta();
        line--;
        ArrayList<String> Lr = new ArrayList<>();
        if(line>-1 && line<ism.getLore().size()){
